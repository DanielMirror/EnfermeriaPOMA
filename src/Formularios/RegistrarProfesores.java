...
public class RegistrarProfesores extends javax.swing.JInternalFrame {
    ...
    private void InsertarRegistro() {
        ...
        CedulaPro = Consulta.buscarCedulaPro(Nombre);
        
        Consulta.RegistrarProfesor(Fecha, HoraLlegada, HoraSalida, Cedula, Diagnostico, CedulaPro);
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Nuevo Registro Profesor");
